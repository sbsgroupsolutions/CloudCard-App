...
- (void)setupLabels {
    ...
    CGRect boxRect = CGRectMake(roundf((allRect.size.width - 40) / 2) + self.xOffset,
                                roundf((allRect.size.height - 40) / 2) + self.yOffset-30, 40, 40);
    
    
    
    imgview=[[UIImageView alloc] initWithFrame:boxRect];
        imgview.image=[UIImage imageNamed:@"loading_spinner.png"];
...
- (void) spinWithOptions: (UIViewAnimationOptions) options {
    ...
    [UIView animateWithDuration: 0.5f
                        ...
                        options: options
                     animations: ^{
                         imgview.transform = CGAffineTransformRotate(imgview.transform, M_PI / 2);
                     }
